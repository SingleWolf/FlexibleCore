package com.walker.core.view.banner.view;
...
import com.walker.core.view.ViewPagerScroller;
import com.walker.core.view.banner.adapter.MultiPagerAdapter;
import com.walker.core.view.banner.holder.HolderCreator;
import com.walker.core.view.banner.holder.ViewHolder;
 ...
 * @desc 多功能Banner
 */
public class MultiBanner<T> extends FrameLayout {
    /**
     * ViewPager
     */
    ...
    private void init(AttributeSet attrs, Context context) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.core_layout_banner_default, this);
